      ...
      <div className="space-y-3">
        {bills.map((bill) => (
          <a
            ...
            className="block p-5 bg-card border border-amber-200 rounded-xl hover:border-amber-400 hover:shadow-lg transition-all duration-200 group"
          >
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0 mr-4">
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground flex-wrap">
                  ...
                  <span className="bg-secondary text-gray-700 px-2 py-1 rounded-full text-xs font-medium">
